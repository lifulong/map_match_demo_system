...
if(isset($_GET['dir']))
	...
	$path=$_SERVER['DOCUMENT_ROOT'].'/data/road/';

$result=getAllFiles($path);

foreach($result as $file){
	if(is_file($path.$file))
        	$linkTag="&nbsp;&nbsp;&nbsp<a target='_blank' href='http://".$_SERVER['HTTP_HOST'].'/road_demo/index.php?file='.$path.$file."'>".$file."</a>";
	else if(is_dir($path.$file))
        	$linkTag="&nbsp;&nbsp;&nbsp<a target='_blank' href='http://".$_SERVER['HTTP_HOST'].'/road_demo/all.php?dir='.$path.$file."'>".$file."</a>";
	echo $linkTag."<br/>";
}
?>
